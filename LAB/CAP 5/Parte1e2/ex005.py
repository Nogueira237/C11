...
diferencaDoisAnos = diferencaAnos*2
#print(diferencaDoisAnos)

novasPorcentagens = seriesAno2 + diferencaDoisAnos
print(f"A linguagem mais popular depois de dois anos é: {novasPorcentagens.nlargest(1)}.")
